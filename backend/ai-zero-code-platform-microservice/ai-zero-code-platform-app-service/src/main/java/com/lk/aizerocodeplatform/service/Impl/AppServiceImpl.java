...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public String appDeploy(Long appId, UserLoginVO userLoginVO) {
        ...
        updateCoverAsync(appId, buildLocalDeployUrl(deployUrl));
        return deployUrl;
    }
    ...
    private String buildDeployUrl(String deployKey) {
        ...
        return normalizedContextPath + "/static/deploy/" + deployKey + "/";
    }

    private String buildLocalDeployUrl(String deployUrl) {
        return "http://localhost:" + serverPort + deployUrl;
    }
